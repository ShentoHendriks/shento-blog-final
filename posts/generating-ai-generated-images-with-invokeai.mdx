...
## Downloading models
<Steps vertical>
  <Step title="Navigate to Model Manager" vertical>
  ...
  <Step title="Installing a Starter Model" vertical>
...
Click on the `+` icon to install them.
  ...
  <Step title="Prune clean-up" vertical>
...
<Callout>
Visit [civitai.com](https://civitai.com) to browse thousands of community-created models with different artistic styles. Note: This site contains adult content—use filters if needed.
</Callout>
